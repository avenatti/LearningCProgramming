...
_I'm documenting my experience teaching myself the C programming language. Hopefully you can learn from experiences (good or bad) and optimize your own path. I will explain each resource, note the cost, time commitment, rating (scale from 1-10 where higher numbers are better), and the days I actually made progress.<br/><br/>
`The "/Examples" folder structure matches resource numbering below.`_
<p align="center">
  <br/>
...
Variables and Data Types in C | 7 | 120 min | 1.0x | 2 | https://app.pluralsight.com/library/courses/variables-data-types-c/
Managing Data and Memory Allocation in C | X | 120 min | 1.0x | 3 | https://app.pluralsight.com/library/courses/managing-data-memory-allocation-c/
